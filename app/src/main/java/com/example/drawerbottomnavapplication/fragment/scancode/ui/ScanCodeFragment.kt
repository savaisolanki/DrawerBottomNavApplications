package com.example.drawerbottomnavapplication.fragment.scancode.ui
...
import com.example.drawerbottomnavapplication.databinding.FragmentScanCodeBinding
...
class ScanCodeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainActivity.supportActionBar?.title = "Scan Code"
